...
## Changelog
- June 26, 2025: Fixed critical database constraint violation in contact creation - corrected mapApiPayloadToWhatsappContact function to use instanceName field instead of instanceId, resolving "null value in column instance_name" errors during webhook processing, messaging system now fully operational with proper contact creation and database field alignment
